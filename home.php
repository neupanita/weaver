...
?>
	 ...
	 ?>
   	 ...
   	 <?php  
	 echo "<img src=$picture[2] width=\"100\" height=\"150\">";
	 ?>
	 ...
	 <?php 
				 ...
				 echo " <div class=\"detail_button\"><a href=\"?link=detail.php & id=$ISBN[1]\">Detail</a></div>";
				 if($_SESSION['id']!=="admin")
							echo " <div class=\"buy_now_button\"><a href=\"?link=reserve.php & id=$ISBN[2]\">Order</a></div>";
				?>
                </div>
                <div class="cleaner">&nbsp;</div>
            </div>
	 ...
	 <?php echo $author[4];?>
   	 ...
   	 <?php  echo "<img src=$picture[4]  width=\"100\" height=\"150\">";?>
                ...
                <div class="product_info">
				 ...
				 if($_SESSION['id']!=="admin")
							echo " <div class=\"buy_now_button\"><a href=\"?link=reserve.php & id=$ISBN[4]\">Order</a></div>";?>
                </div>
                 <div class="cleaner">&nbsp;</div>
            </div>
