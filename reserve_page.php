...
?>
 ...
 <div id="templatemo_content_right">
   <?php  
	...
	while($i!=$cnt && $i<4)
    {   echo " <div class=\"templatemo_product_box1\"><h1>$bookname[$j]</h1><img src=$picture[$j] width=\"100\" height=\"150\"><div class=\"product_info\"><p>ISBN :$isbn[$i]</p><p>Author:$author[$i]</p><p>Price:$price[$i]</p><p>Quantity Reserved:$qnt[$i]</p><div class=\"detail_button\"><a href=\"?link=editquantity.php & id=$isbn[$j]\">Edit Quantity</a></div>
				<div class=\"buy_now_button\"><a href=\"?link=deletequantity.php & id=$reserveid[$j]\">Delete Order</a></div>
