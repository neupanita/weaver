...
?>
 ...
 <div id="templatemo_content_right">
   <?php  
	...
	echo "<h1>$category</h1>";
	while($i!=$cnt && $i<4)
    {   echo " <div class=\"templatemo_product_box1\"><h1>$bookname[$j]</h1><img src=$picture[$j] width=\"100\" height=\"150\">
	<div class=\"product_info\"><p>ISBN :$ISBN[$i]</p><p>Author:$author[$i]</p><p>Price:$price[$i]</p><div class=\"detail_button\">
	<a href=\"?link=detail.php & id=$ISBN[$j]\">Detail</a></div>";
